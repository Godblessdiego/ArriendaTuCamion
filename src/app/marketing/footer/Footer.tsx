...
const Footer = () => {
  ...
  return (
    <footer className={`${isDark ? "bg-slate-900" : "bg-slate-900"} text-white`}>
      <div className="container mx-auto px-6">
        {/* Main Footer Content */}
        <div className="py-16 grid md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="md:col-span-2">
            <div className="text-3xl font-bold mb-4">ArriendaTuCamión</div>
            <p
              className="text-white/80 mb
-6 max-w-md leading-relaxed"
            >
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white/80">+56 9 XXXX XXXX</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg
                  className="w-4 h-4 text-amber-400"
                ...
                <span className="text-white/80">contacto@arriendatucamion.cl</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg
                  className="w-4 h-4 text-amber-400"
              ...
              <a
                ...
                className="inline-flex items-center space-x-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full transition-colors mt-4"
              >
        ...
        <div className="border-t border-white/20 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-white/80 text-sm">
              © 2024 ArriendaTuCamión. Todos los derechos reservados.
            </p>
